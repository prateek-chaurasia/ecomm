...
urlpatterns = [
    ...
    path('shipping-address/delete/<uuid:address_uid>/', delete_shipping_address, name='delete_shipping_address'),
    ...
    path('remove-bundle/<uid>/', remove_bundle, name="remove_bundle"),
